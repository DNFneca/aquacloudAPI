...
public class FollowingService {
    ...
    public void deleteFollowing(User follower, User following) throws IOException {
        followingRepository.deleteByFollowerAndFollowing(follower, following);
    }


    public void deleteFollowing(String followerTag, String followingTag) throws IOException {
        followingRepository.deleteByFollowerTagAndFollowingTag(followerTag, followingTag);
    }
